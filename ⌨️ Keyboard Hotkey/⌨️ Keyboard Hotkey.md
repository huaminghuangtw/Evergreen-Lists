...
| <kbd>Cmd</kbd> + <kbd>`</kbd> = <kbd>Ctrl</kbd> + <kbd>J</kbd> | Show/Hide Terminal |
...
| <kbd>Cmd</kbd> + <kbd>Shift</kbd> + <kbd>M</kbd> | Open Problems panel (for linting and errors) |
...
| <kbd>Ctrl</kbd> + <kbd>Tab</kbd> | Moves to the next tab on the right |
| <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>Tab</kbd> | Moves to the previous tab on the left |
